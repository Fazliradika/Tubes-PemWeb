<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                ...
                <div
                    class="bg-white dark:bg-slate-800 overflow-hidden shadow-sm sm:rounded-xl border border-gray-100 dark:border-slate-700">
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                <p class="text-sm font-medium text-gray-500 dark:text-gray-400">Upcoming Appointments
                                </p>
            ...
            <div
                class="bg-white dark:bg-slate-800 overflow-hidden shadow-sm sm:rounded-xl border border-gray-100 dark:border-slate-700 mb-6">
                <div class="p-6">
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-4">Your Upcoming Appointments</h3>
                    <div class="space-y-4">
                        @forelse($upcomingAppointments as $appointment)
                            <div
                                class="flex items-center justify-between p-4 bg-emerald-50 dark:bg-emerald-900/20 border border-emerald-100 dark:border-emerald-800/50 rounded-xl">
                                <div class="flex items-center">
                                    <div
                                        class="flex-shrink-0 h-12 w-12 bg-emerald-500 rounded-full flex items-center justify-center text-white font-semibold overflow-hidden">
                                        @if($appointment->doctor && $appointment->doctor->user && $appointment->doctor->user->profile_photo)
                                            <img src="{{ asset('storage/' . $appointment->doctor->user->profile_photo) }}"
                                                alt="{{ $appointment->doctor->user->name }}" class="h-12 w-12 object-cover">
                                        @else
                        ...
                        @empty
                            <div class="text-center py-8">
                                ...
                                <h4 class="mt-4 text-lg font-medium text-gray-900 dark:text-white">No Upcoming Appointments
                                </h4>
                                <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">You don't have any scheduled
                                    appointments yet.</p>
                                <a href="{{ route('appointments.index') }}"
                                    class="mt-4 inline-flex items-center px-4 py-2 bg-emerald-600 hover:bg-emerald-700 text-white text-sm font-medium rounded-lg transition">
            ...
            <div
                ...
                <div class="p-6">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                        <a href="{{ route('appointments.index') }}"
                            class="flex flex-col items-center justify-center p-4 bg-emerald-50 dark:bg-emerald-900/20 hover:bg-emerald-100 dark:hover:bg-emerald-900/40 border border-emerald-100 dark:border-emerald-800/50 rounded-xl transition">
                            <svg class="h-8 w-8 text-emerald-600 dark:text-emerald-400 mb-2" fill="none"
                                stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M12 4v16m8-8H4" />
                            </svg>
                        ...
                        <a href="{{ route('appointments.my-appointments') }}"
                            class="flex flex-col items-center justify-center p-4 bg-teal-50 dark:bg-teal-900/20 hover:bg-teal-100 dark:hover:bg-teal-900/40 border border-teal-100 dark:border-teal-800/50 rounded-xl transition">
                            <svg class="h-8 w-8 text-teal-600 dark:text-teal-400 mb-2" fill="none" stroke="currentColor"
                                viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                            </svg>
                        ...
                        <a href="{{ route('prescriptions.index') }}"
                            class="flex flex-col items-center justify-center p-4 bg-cyan-50 dark:bg-cyan-900/20 hover:bg-cyan-100 dark:hover:bg-cyan-900/40 border border-cyan-100 dark:border-cyan-800/50 rounded-xl transition">
                            <svg class="h-8 w-8 text-cyan-600 dark:text-cyan-400 mb-2" fill="none" stroke="currentColor"
                                viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4" />
                            </svg>
                        ...
                        <a href="{{ route('chat.index') }}"
                            class="flex flex-col items-center justify-center p-4 bg-slate-50 dark:bg-slate-700/50 hover:bg-slate-100 dark:hover:bg-slate-700 border border-slate-100 dark:border-slate-600 rounded-xl transition">
                            <svg class="h-8 w-8 text-slate-600 dark:text-slate-400 mb-2" fill="none"
                                stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div
                ...
                <div class="p-6">
                    <div class="flex items-center justify-between mb-6">
                        <h3 class="text-2xl font-bold text-gray-800 dark:text-white">Artikel Kesehatan Terkini untuk
                            Anda</h3>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        <!-- Article 1 -->
                        <a href="{{ route('articles.show', '7-makanan-yang-bikin-kurus-cocok-untuk-menu-diet-harian') }}"
                            class="article-card block" data-category="Hidup Sehat">
                            <div
                                class="bg-white dark:bg-slate-700 border border-gray-100 dark:border-slate-600 rounded-xl overflow-hidden hover:shadow-lg hover:border-emerald-200 dark:hover:border-emerald-700 transition-all duration-300">
                                <div class="relative">
                                    <img src="https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=400&h=250&fit=crop"
                                        alt="Healthy Food" class="w-full h-48 object-cover">
                                    <span
                                        class="absolute top-3 left-3 bg-emerald-500 text-white text-xs font-semibold px-3 py-1 rounded-full">
                                        Hidup Sehat
                                    </span>
                                </div>
                                <div class="p-4">
                                    <h4
                                        class="text-lg font-bold text-gray-800 dark:text-white mb-2 hover:text-emerald-600 dark:hover:text-emerald-400 cursor-pointer">
                                        7 Makanan yang Bikin Kurus, Cocok untuk Menu Diet Harian
                                    </h4>
                                    <p class="text-sm text-gray-600 dark:text-gray-400 mb-3">
                                        Makanan yang bikin kurus menjadi incaran banyak orang yang ingin menurunkan
                                        berat badan tanpa rasa lapar atau tersiksa. Dengan memilih...
                                    </p>
                                    <div
                                        class="flex items-center justify-between text-xs text-gray-500 dark:text-gray-400 dark:text-gray-400">
                        ...
                        <!-- Article 2 -->
                        <a href="{{ route('articles.show', 'tips-olahraga-efektif-untuk-kesehatan-jantung') }}"
                            class="article-card block" data-category="Olahraga">
                            <div
                                class="bg-white dark:bg-slate-700 border border-gray-100 dark:border-slate-600 rounded-xl overflow-hidden hover:shadow-lg hover:border-teal-200 dark:hover:border-teal-700 transition-all duration-300">
                                <div class="relative">
                                    <img src="https://images.unsplash.com/photo-1505576399279-565b52d4ac71?w=400&h=250&fit=crop"
                                        alt="Exercise" class="w-full h-48 object-cover">
                                    <span
                                        class="absolute top-3 left-3 bg-teal-500 text-white text-xs font-semibold px-3 py-1 rounded-full">
                                        Olahraga
                                    </span>
                                </div>
                                <div class="p-4">
                                    ...
                                    <p class="text-sm text-gray-600 dark:text-gray-400 mb-3">
                                        Olahraga teratur sangat penting untuk menjaga kesehatan jantung. Pelajari jenis
                                        olahraga yang paling efektif untuk meningkatkan fungsi...
                                    </p>
                                    <div
                        ...
                        <!-- Article 3 -->
                        <a href="{{ route('articles.show', 'mengelola-diabetes-dengan-pola-makan-sehat') }}"
                            class="article-card block" data-category="Diabetes">
                            <div
                                class="bg-white dark:bg-slate-700 border border-gray-100 dark:border-slate-600 rounded-xl overflow-hidden hover:shadow-lg hover:border-cyan-200 dark:hover:border-cyan-700 transition-all duration-300">
                                <div class="relative">
                                    <img src="https://images.unsplash.com/photo-1505751172876-fa1923c5c528?w=400&h=250&fit=crop"
                                        alt="Diabetes" class="w-full h-48 object-cover">
                                    <span
                                        class="absolute top-3 left-3 bg-cyan-500 text-white text-xs font-semibold px-3 py-1 rounded-full">
                                        Diabetes
                                    </span>
                                </div>
                                <div class="p-4">
                                    ...
                                    <p class="text-sm text-gray-600 dark:text-gray-400 mb-3">
                                        Pola makan yang tepat sangat penting bagi penderita diabetes. Temukan panduan
                                        lengkap tentang makanan yang aman dan nutrisi yang...
                                    </p>
                                    <div
                                        class="flex items-center justify-between text-xs text-gray-500 dark:text-gray-400">
                            ...
                            <!-- Article 4 -->
                            <a href="{{ route('articles.show', 'pentingnya-vitamin-dan-mineral-untuk-tubuh') }}"
                                class="article-card block" data-category="Nutrisi">
                                <div
                                    class="bg-white dark:bg-slate-700 border border-gray-200 dark:border-slate-600 rounded-lg overflow-hidden hover:shadow-lg transition-shadow duration-300">
                                    <div class="relative">
                                        <img src="https://images.unsplash.com/photo-1498837167922-ddd27525d352?w=400&h=250&fit=crop"
                                            alt="Nutrition" class="w-full h-48 object-cover">
                                        <span
                                    ...
                                    <div class="p-4">
                                        ...
                                        <p class="text-sm text-gray-600 dark:text-gray-400 mb-3">
                                            Vitamin dan mineral adalah nutrisi esensial yang dibutuhkan tubuh. Pelajari
                                            manfaat masing-masing vitamin dan sumber makanan terbaik...
                                        </p>
                                        <div
                                            class="flex items-center justify-between text-xs text-gray-500 dark:text-gray-400">
                            ...
                            <!-- Article 5 -->
                            <a href="{{ route('articles.show', 'cara-mengatasi-stres-dan-menjaga-kesehatan-mental') }}"
                                class="article-card block" data-category="Kesehatan Mental">
                                <div
                                    class="bg-white dark:bg-slate-700 border border-gray-200 dark:border-slate-600 rounded-lg overflow-hidden hover:shadow-lg transition-shadow duration-300">
                                    <div class="relative">
                                    ...
                                    <div class="p-4">
                                        ...
                                        <p class="text-sm text-gray-600 dark:text-gray-400 mb-3">
                                            Kesehatan mental sama pentingnya dengan kesehatan fisik. Temukan strategi
                                            efektif untuk mengelola stres dan meningkatkan kesejahteraan...
                                        </p>
                                        <div
                                            class="flex items-center justify-between text-xs text-gray-500 dark:text-gray-400">
                            ...
                            <!-- Article 6 -->
                            <a href="{{ route('articles.show', 'tips-tidur-berkualitas-untuk-kulit-sehat-dan-bercahaya') }}"
                                class="article-card block" data-category="Kecantikan">
                                <div
                                    class="bg-white dark:bg-slate-700 border border-gray-200 dark:border-slate-600 rounded-lg overflow-hidden hover:shadow-lg transition-shadow duration-300">
                                    <div class="relative">
                                        <img src="https://images.unsplash.com/photo-1541781774459-bb2af2f05b55?w=400&h=250&fit=crop"
                                            alt="Sleep" class="w-full h-48 object-cover">
                                        <span
                                    ...
                                    <div class="p-4">
                                        ...
                                        <p class="text-sm text-gray-600 dark:text-gray-400 mb-3">
                                            Tidur yang cukup dan berkualitas sangat penting untuk kesehatan kulit.
                                            Pelajari bagaimana tidur mempengaruhi kecantikan dan tips untuk...
                                        </p>
                                        <div
                                            class="flex items-center justify-between text-xs text-gray-500 dark:text-gray-400">
                                            <span>6 min read</span>
            ...
            <div
                class="bg-white dark:bg-slate-800 overflow-hidden shadow-sm sm:rounded-lg border border-gray-100 dark:border-slate-700 mb-6">
                <div class="p-8">
                    <h3 class="text-3xl font-bold text-gray-900 dark:text-white mb-3">Kata Mereka tentang HealthFirst
                        Medical</h3>
                    <p class="text-gray-600 dark:text-gray-400 mb-10 max-w-3xl">
                        Cerita dari pasien yang merasakan layanan kesehatan cepat, aman, dan nyaman di HealthFirst
                        Medical.
                    </p>
                        ...
                        <div class="flex flex-col space-y-5">
                            <div class="flex items-start space-x-4">
                                ...
                                <div>
                                    ...
                                    <p
                                        class="uppercase tracking-wide text-[11px] text-gray-500 dark:text-gray-400 mt-3">
                                        SAINEM WIYONO</p>
                                </div>
                            </div>
                            <button
                                class="w-fit px-5 py-2 border border-blue-500 dark:border-blue-400 text-blue-500 dark:text-blue-400 rounded-full text-xs font-semibold hover:bg-blue-50 dark:hover:bg-blue-900/20 transition">
                                Lihat Layanan
                            </button>
                        </div>
                            ...
                            <div class="flex items-start space-x-4">
                                ...
                                <div>
                                    <p class="italic text-gray-800 dark:text-gray-200 leading-relaxed">
                                        ...
                                        juga baik. resep obatnya juga manjur sekali, thank u ya semoga kedepannya tambah
                                        keren lagi.”
                                    </p>
                                    <p
                                        class="uppercase tracking-wide text-[11px] text-gray-500 dark:text-gray-400 mt-3">
                                        LINTANG ANINDHITYA INDRASWARI</p>
                                </div>
                            </div>
                            <button
                                class="w-fit px-5 py-2 border border-blue-500 dark:border-blue-400 text-blue-500 dark:text-blue-400 rounded-full text-xs font-semibold hover:bg-blue-50 dark:hover:bg-blue-900/20 transition">
                            ...
                            <div class="flex items-start space-x-4">
                                ...
                                <div>
                                    <p class="italic text-gray-800 dark:text-gray-200 leading-relaxed">
                                        ...
                                        care, kamarnya nyaman, dan makanannya enak. Terima kasih atas pelayanan
                                        terbaiknya!”
                                    </p>
                                    <p
                                        class="uppercase tracking-wide text-[11px] text-gray-500 dark:text-gray-400 mt-3">
                            ...
                            <div class="flex items-start space-x-4">
                                ...
                                <div>
                                    <p class="italic text-gray-800 dark:text-gray-200 leading-relaxed">
                                        ...
                                        kulitku sudah banyak mengalami perubahan. Jerawat dan bekasnya semakin membaik
                                        berkat saran dokter-dokter HealthFirst Medical. Jujur baru kali ini bisa
                                        konsultasi dengan dokter kulit secara leluasa dan terbuka, semua pertanyaan
                                        tentang jerawatku dijawab secara gamblang.”
                                    </p>
                                    <p
                                        class="uppercase tracking-wide text-[11px] text-gray-500 dark:text-gray-400 mt-3">
                                        IZZA AFKARINA MUDMAINAH</p>
                                </div>
                            </div>
                            <button
                                class="w-fit px-5 py-2 border border-blue-500 dark:border-blue-400 text-blue-500 dark:text-blue-400 rounded-full text-xs font-semibold hover:bg-blue-50 dark:hover:bg-blue-900/20 transition">
            ...
            @php
                $healthTips = [
                    "Ingat untuk tetap terhidrasi! Minum 8 gelas air setiap hari membantu menjaga fungsi tubuh dan membuat Anda tetap berenergi sepanjang hari.",
                    "Tidur yang cukup sangat penting. Usahakan tidur 7-8 jam setiap malam untuk kesehatan optimal.",
                    "Jangan lewatkan sarapan! Sarapan yang sehat memberikan energi untuk memulai hari dengan baik.",
                    "Olahraga rutin minimal 30 menit sehari dapat meningkatkan kesehatan jantung dan suasana hati.",
                    "Kurangi konsumsi garam berlebih untuk menjaga tekanan darah tetap normal.",
                    "Makan sayur dan buah setiap hari. Targetkan 5 porsi untuk nutrisi yang seimbang.",
                    "Istirahatkan mata setiap 20 menit saat bekerja di depan layar komputer.",
                    "Cuci tangan dengan sabun selama minimal 20 detik untuk mencegah penyebaran kuman.",
                    "Batasi konsumsi gula tambahan. Pilih buah segar sebagai camilan sehat.",
                    "Jalan kaki 10.000 langkah sehari dapat membantu menjaga berat badan ideal.",
                    "Konsumsi makanan kaya serat untuk pencernaan yang sehat.",
                    "Hindari merokok dan paparan asap rokok untuk kesehatan paru-paru.",
                    "Kelola stres dengan meditasi atau teknik pernapasan dalam 5-10 menit sehari.",
                    "Periksa kesehatan secara rutin, minimal setahun sekali.",
                    "Konsumsi ikan yang kaya omega-3 minimal 2 kali seminggu untuk kesehatan otak.",
                    "Jangan abaikan vaksinasi. Vaksin melindungi Anda dan orang-orang di sekitar.",
                    "Batasi konsumsi kafein, maksimal 400mg per hari atau sekitar 4 cangkir kopi.",
                    "Makan dengan perlahan dan nikmati setiap suapan untuk pencernaan yang lebih baik.",
                    "Jaga postur tubuh yang baik saat duduk untuk mencegah sakit punggung.",
                    "Luangkan waktu untuk bersosialisasi. Kesehatan mental sama pentingnya dengan kesehatan fisik.",
                    "Hindari makanan olahan berlebihan dan pilih makanan segar.",
                    "Gunakan tabir surya SPF 30+ saat beraktivitas di luar ruangan.",
                    "Konsumsi probiotik untuk kesehatan usus yang optimal.",
                    "Batasi waktu layar sebelum tidur untuk kualitas tidur yang lebih baik.",
                    "Minum teh hijau yang kaya antioksidan untuk kesehatan tubuh.",
                    "Lakukan peregangan ringan setiap pagi untuk fleksibilitas tubuh.",
                    "Konsumsi kacang-kacangan sebagai sumber protein nabati yang sehat.",
                    "Jaga kebersihan gigi dengan menyikat 2 kali sehari dan flossing rutin.",
                    "Tertawa adalah obat terbaik! Luangkan waktu untuk bersenang-senang.",
                    "Konsumsi vitamin D dari sinar matahari pagi selama 10-15 menit.",
                    "Bersyukur setiap hari dapat meningkatkan kesehatan mental dan kebahagiaan."
                ];
                $dayOfMonth = (int) date('j') - 1; // 0-30 index
                $todayTip = $healthTips[$dayOfMonth % count($healthTips)];
            @endphp
            <div id="healthTipSection"
                class="bg-gradient-to-r from-teal-50 to-green-50 dark:from-teal-900/20 dark:to-green-900/20 overflow-hidden shadow-sm sm:rounded-lg border border-teal-200 dark:border-teal-800">
                <div class="p-6">
                    <div class="flex items-start">
                        ...
                        <div class="ml-3">
                            <h3 class="text-sm font-semibold text-teal-900 dark:text-teal-100">Health Tip of the Day
                            </h3>
    ...
    <div id="aiChatSidebar"
        class="fixed top-0 right-0 h-full w-full md:w-[420px] bg-white dark:bg-slate-800 shadow-2xl transform translate-x-full transition-transform duration-300 ease-in-out z-50 flex flex-col rounded-l-3xl overflow-hidden">
        <!-- Header -->
        <div class="bg-gradient-to-r from-blue-600 to-blue-500 text-white p-5">
            <div class="flex items-center justify-between mb-4">
                ...
                <button id="aiChatClose"
                    class="text-white hover:bg-white/20 rounded-xl p-2.5 transition-all duration-200">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div class="flex items-center gap-2">
                <select id="chatSelect"
                    class="flex-1 text-gray-700 bg-white rounded-xl px-3 py-2.5 text-sm font-medium shadow-sm border-0 focus:ring-2 focus:ring-blue-300">
                    <option value="">💬 Percakapan baru...</option>
                </select>
                <button id="newChatButton"
                    class="bg-white/20 hover:bg-white/30 text-white px-4 py-2.5 rounded-xl transition-all duration-200 flex items-center gap-2 font-medium">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4" />
                    </svg>
                    <span class="hidden sm:inline">Baru</span>
                </button>
                <button id="deleteChatButton"
                    class="hidden bg-red-500/80 hover:bg-red-500 text-white px-3 py-2.5 rounded-xl transition-all duration-200">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <div id="chatMessages"
            class="flex-1 overflow-y-auto p-5 space-y-4 bg-gradient-to-b from-blue-50/50 to-white dark:from-slate-800 dark:to-slate-800">
            <!-- Welcome Message -->
            <div class="flex items-start space-x-3">
                ...
                <div
                    class="bg-white dark:bg-slate-700 rounded-2xl rounded-tl-md p-4 shadow-sm max-w-[85%] border border-blue-100 dark:border-slate-600">
                    <p class="text-sm text-gray-700 dark:text-gray-200 leading-relaxed">
                        👋 <strong>Halo!</strong> Saya <span
                            class="text-blue-600 dark:text-blue-400 font-semibold">Health First AI Assistant</span>.
                        Saya siap membantu menjawab pertanyaan seputar kesehatan Anda. Silakan tanyakan apa saja!
                    </p>
                    <div
                        class="mt-3 p-2.5 bg-amber-50 dark:bg-amber-900/30 rounded-xl border border-amber-200 dark:border-amber-700">
                        <p class="text-xs text-amber-700 dark:text-amber-300 flex items-start gap-2">
                            <span class="text-amber-500">⚠️</span>
                            <span>Saya bukan pengganti dokter. Untuk diagnosis dan pengobatan, konsultasikan dengan
                                dokter profesional.</span>
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="border-t border-gray-100 dark:border-slate-700 p-4 bg-white dark:bg-slate-800">
            <form id="aiChatForm" class="space-y-3">
                <div class="relative">
                    <textarea id="aiChatInput" rows="2"
                        ...
                        placeholder="Ketik pertanyaan kesehatan Anda..." maxlength="1000"></textarea>
                    <!-- Mic Button Inside Input -->
                    <button type="button" id="micButton" title="Klik untuk bicara"
                        ...
                        <svg id="micIconIdle" class="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                            aria-hidden="true">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M12 18.75a6 6 0 006-6v-1.5m-12 0v1.5a6 6 0 006 6z" />
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M12 14.25a2.25 2.25 0 002.25-2.25V6a2.25 2.25 0 00-4.5 0v6A2.25 2.25 0 0012 14.25z" />
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M8.25 18.75H12m0 0h3.75M12 18.75V21" />
                        </svg>
                        <svg id="micIconOn" class="w-5 h-5 hidden" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                            aria-hidden="true">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M12 18.75a6 6 0 006-6v-1.5m-12 0v1.5a6 6 0 006 6z" />
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    <script>
        ...
        // Position AI button relative to Health Tip section
        function updateAiButtonPosition() {
            const healthTipSection = document.getElementById('healthTipSection');
            const footer = document.querySelector('footer');
            if (!healthTipSection || !chatToggle) return;

            const healthTipRect = healthTipSection.getBoundingClientRect();
            const footerRect = footer ? footer.getBoundingClientRect() : { top: window.innerHeight };
            const viewportHeight = window.innerHeight;
            const buttonHeight = chatToggle.offsetHeight;
            const bottomOffset = 24; // 6 * 4 = 24px (bottom-6)

            // Calculate the position where the button should stop
            // It should stop when its bottom edge would go below the Health Tip section top
            const maxBottomPosition = viewportHeight - healthTipRect.top + bottomOffset;

            if (healthTipRect.top < viewportHeight - buttonHeight - bottomOffset) {
                // Health tip section is visible, position button above it
                const newBottom = Math.max(maxBottomPosition, bottomOffset);
                chatToggle.style.bottom = newBottom + 'px';
        ...
        window.addEventListener('scroll', updateAiButtonPosition);
        window.addEventListener('resize', updateAiButtonPosition);
        document.addEventListener('DOMContentLoaded', updateAiButtonPosition);
