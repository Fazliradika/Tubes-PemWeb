        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            @if($appointments->count() > 0)
                <div class="space-y-4">
                    @foreach($appointments as $appointment)
                        <div
                            class="bg-white dark:bg-slate-800 rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-200">
                            <div class="md:flex">
                                <!-- Appointment Info -->
                                <div class="flex-1 p-6">
                                    ...
                                    @if($appointment->symptoms)
                                        <div class="mb-4">
                                            <p class="text-sm font-semibold text-gray-700 mb-1">Keluhan:</p>
                                            <p class="text-gray-600 text-sm">{{ Str::limit($appointment->symptoms, 100) }}</p>
                                        </div>
                                    @endif
            ...
            @else
                <div class="bg-white dark:bg-slate-800 rounded-lg shadow-sm p-12 text-center">
                    ...
                    <h3 class="text-lg font-medium text-gray-900 mb-2">Belum ada appointment</h3>
                    <p class="text-gray-600 mb-6">Mulai buat appointment dengan dokter pilihan Anda</p>
