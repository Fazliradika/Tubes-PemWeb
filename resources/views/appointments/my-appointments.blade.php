    ...
    <div class="min-h-screen bg-gray-50 py-8">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="mb-8">
                ...
                <p class="mt-2 text-gray-600 dark:text-gray-400">Kelola dan lihat riwayat appointment Anda</p>
            </div>
                                ...
                                <div class="flex-1 p-6">
                                    <div class="flex items-start justify-between mb-4">
                                        <div>
                                            ...
                                            <p class="text-blue-600 dark:text-blue-400">{{ $appointment->doctor->specialization }}
                                            </p>
                                        </div>
