...
<div class="min-h-screen bg-gray-50 py-8">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <!-- Back Button -->
        <div class="mb-6">
            <a href="{{ route('appointments.index') }}" class="inline-flex items-center text-blue-600 hover:text-blue-700">
                ...
                <div class="md:w-1/3 bg-gradient-to-br from-blue-500 to-blue-600 p-8 text-white">
                    <div class="text-center">
                        ...
                        <div class="bg-white/20 rounded-lg p-4 mt-6">
                            ...
                            <p class="text-3xl font-bold">Rp {{ number_format($doctor->price_per_session, 0, ',', '.') }}</p>
                        </div>
                    </div>
                </div>
                    ...
                    <form method="POST" action="{{ route('appointments.store', $doctor) }}" class="space-y-6">
                        ...
                        <div>
                            ...
                            <input type="time" 
                                   ...
                                   max="{{ \Carbon\Carbon::parse($doctor->end_time)->format('H:i') }}"
                                   required
