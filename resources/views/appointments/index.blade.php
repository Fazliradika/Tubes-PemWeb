        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            <div class="flex items-center justify-between">
                ...
                <a href="{{ route('dashboard') }}"
                    class="text-white hover:text-blue-100 transition-colors duration-200 flex items-center gap-2">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    @foreach($doctors as $doctor)
                        <div
                            ...
                            <!-- Doctor Photo -->
                            <div class="aspect-[4/3] bg-gradient-to-br from-blue-500 to-blue-600 relative overflow-hidden">
                                @if($doctor->photo)
                                    <img src="{{ str_starts_with($doctor->photo, 'http') ? $doctor->photo : asset('storage/' . $doctor->photo) }}"
                                        alt="{{ $doctor->user->name }}" class="w-full h-full object-cover object-center"
                                ...
                                <div class="mb-4 p-3 bg-gray-50 dark:bg-slate-700 rounded-lg">
                                    ...
                                    <div class="flex flex-wrap gap-1 mb-2">
                                        @foreach($doctor->available_days as $day)
                                            <span
                                                class="px-2 py-1 bg-blue-100 dark:bg-blue-900 text-blue-700 dark:text-blue-200 text-xs rounded">
                                                {{ $day }}
                                            </span>
                                        @endforeach
                                    </div>
