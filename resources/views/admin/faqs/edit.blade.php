    ...
    <x-slot name="header">
        <div class="flex items-center gap-4">
            ...
            <div>
                ...
                <p class="text-blue-100 text-sm mt-1">Perbarui pertanyaan yang sering diajukan.</p>
            </div>
        </div>
    </x-slot>
    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-slate-800 overflow-hidden shadow-xl sm:rounded-2xl border border-blue-50 dark:border-slate-700">
                <form action="{{ route('admin.faqs.update', $faq) }}" method="POST" class="p-8">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div>
                                ...
                                <select name="category" id="category" required
                                    ...
                                    <option value="account" {{ old('category', $faq->category) == 'account' ? 'selected' : '' }}>Akun</option>
                                    <option value="other" {{ old('category', $faq->category) == 'other' ? 'selected' : '' }}>Lainnya</option>
                                </select>
