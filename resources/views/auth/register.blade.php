<x-guest-layout>
    <div class="mb-6">
        ...
        <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">Daftar sekarang untuk mengakses layanan kesehatan</p>
    </div>
    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="mt-6 text-center border-t pt-6">
            <p class="text-sm text-gray-600">
                ...
                <a class="font-semibold text-blue-600 hover:text-blue-800 underline" href="{{ route('login') }}">
                    {{ __('Login here') }}
                </a>
            </p>
        </div>
