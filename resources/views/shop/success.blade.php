                ...
                <div class="p-8">
                    ...
                    <div class="bg-blue-50 border border-blue-200 rounded-lg p-6 mb-6">
                        <div class="text-center">
                            ...
                            <div class="text-sm text-gray-600 dark:text-gray-400 mt-2">{{ $order->created_at->format('d F Y, H:i') }}</div>
                        </div>
                    </div>
                    ...
                    <div class="border rounded-lg p-6 mb-6">
                        ...
                        @if($order->payment->payment_method == 'bank_transfer')
                            <div class="space-y-4">
                                <p class="text-gray-700 dark:text-gray-300">Silakan transfer ke salah satu rekening berikut:</p>
                        ...
                        @elseif($order->payment->payment_method == 'credit_card')
                            <div class="text-center py-6">
                                <p class="text-gray-700 dark:text-gray-300 mb-4">Anda akan diarahkan ke halaman pembayaran kartu kredit</p>
                        ...
                        @elseif($order->payment->payment_method == 'qris')
                            <div class="text-center py-6">
                                <p class="text-gray-700 dark:text-gray-300 mb-4 font-semibold">Scan QRIS Code untuk membayar:</p>
