                    ...
                    <div class="mb-6 p-4 bg-blue-50 rounded-lg">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <p class="font-medium">{{ $prescription->prescription_date->format('d M Y') }}</p>
                            </div>
                            @if($prescription->appointment)
                            <div>
                                <p class="text-sm text-gray-600">Keluhan Awal</p>
                                <p class="font-medium">{{ $prescription->appointment->symptoms }}</p>
                            </div>
                            @endif
                        </div>
                    </div>
