<x-app-layout>
                    ...
                    <form action="{{ route('doctor.prescriptions.store', $appointment) }}" method="POST" id="prescriptionForm">
                        ...
                        <div class="mb-6">
                            ...
                            <textarea 
                                ...
                                id="diagnosis" 
                                rows="3" 
                                class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500 @error('diagnosis') border-red-500 @enderror"
                        ...
                        <div class="mb-6">
                            ...
                            <div id="medicineItems" class="space-y-4">
                                ...
                                <div class="medicine-item bg-gray-50 p-4 rounded-lg border" data-index="0">
                                    <div class="flex justify-between items-start mb-3">
                                        <span class="text-sm font-medium text-gray-700">Obat #1</span>
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-3">
                                        <div>
                                            ...
                                            <select name="items[0][product_id]" class="w-full rounded-md border-gray-300 text-sm" required>
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-3">
                                        ...
                                        <div>
                                            <label class="block text-xs text-gray-500 mb-1">Durasi (hari)</label>
                                    ...
                                    <div>
                                        <label class="block text-xs text-gray-500 mb-1">Instruksi Khusus (opsional)</label>
    ...
    <script>
        ...
        function addMedicineItem() {
            ...
            const template = `
                <div class="medicine-item bg-gray-50 p-4 rounded-lg border" data-index="${index}">
                    <div class="flex justify-between items-start mb-3">
                        <span class="text-sm font-medium text-gray-700">Obat #${index + 1}</span>
                        <button type="button" onclick="removeMedicineItem(this)" 
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-3">
                        <div>
                            <label class="block text-xs text-gray-500 mb-1">Nama Obat</label>
                            <select name="items[${index}][product_id]" class="w-full rounded-md border-gray-300 text-sm" required>
                                <option value="">Pilih Obat</option>
