<x-app-layout>
    ...
    <div id="jitsiModal" class="fixed inset-0 z-50 hidden bg-black bg-opacity-95">
        ...
        <div class="absolute bottom-6 left-1/2 transform -translate-x-1/2 z-10">
            <button onclick="closeJitsiModal()" class="text-white hover:text-gray-300 transition bg-red-600 hover:bg-red-700 px-6 py-3 rounded-full font-medium shadow-lg flex items-center space-x-2">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path>
                </svg>
                <span>Tutup Video Call</span>
            </button>
        </div>
    </div>
