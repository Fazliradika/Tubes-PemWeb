...
@section('content')
            ...
            <div class="grid md:grid-cols-3 gap-8">
                ...
                <div class="bg-gray-50 p-6 rounded-lg">
                    <div class="flex items-start space-x-4">
                        ...
                        <div class="flex-1">
                            <p class="italic text-gray-700 leading-relaxed mb-3">
                                "Sangat Helpful!! Terima kasih yaa, sangat menghemat waktu dan respon dokternya juga baik.
                                resep obatnya juga manjur sekali, thank u ya semoga kedepannya tambah keren lagi."
                            </p>
                            <p class="uppercase tracking-wide text-xs text-gray-500 font-medium">LINTANG ANINDHITYA
                                INDRASWARI</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-gray-50 p-6 rounded-lg">
                    <div class="flex items-start space-x-4">
                        ...
                        <div class="flex-1">
                            <p class="italic text-gray-700 leading-relaxed mb-3">
                                "Pengalaman rawat inap di HealthFirst Medical sangat berkesan. Perawatnya sangat care,
                                kamarnya nyaman, dan makanannya enak. Terima kasih atas pelayanan terbaiknya!"
                            </p>
            ...
            <div class="grid md:grid-cols-1 gap-8 mt-8 max-w-2xl">
                ...
                <div class="bg-gray-50 p-6 rounded-lg">
                    <div class="flex items-start space-x-4">
                        ...
                        <div class="flex-1">
                            <p class="italic text-gray-700 leading-relaxed mb-3">
                                "Hallo, terimakasih HealthFirst Medical sejak pertama konsultasi hingga saat ini kulitku
                                sudah banyak mengalami perubahan. Jerawat dan bekasnya semakin membaik berkat saran
                                dokter-dokter HealthFirst Medical. Jujur baru kali ini bisa konsultasi dengan dokter kulit
                                secara leluasa dan terbuka, semua pertanyaan tentang jerawatku dijawab secara gamblang."
                            </p>
    ...
    <section class="py-16">
        <div class="container mx-auto px-4 text-center">
            ...
            <button
                class="px-8 py-3 bg-purple-600 text-white rounded-lg font-semibold hover:bg-purple-700 transition shadow-lg">
